...
def leaky_tanh1(x, length_threshold, alpha=0.01, m=3):
...
class PoolFormer(nn.Module):
    ...
    def forward(self, x, topN_mat_des=None, proxies=None, length_output=100, alpha=0.01, m=3, length_threshold=50):
        # input embedding
        ...
        if self.bce:
            ...
            cls_out = leaky_tanh1(x, length_threshold=length_threshold, alpha=alpha)
            cls_out = torch.matmul(cls_out, proxies.transpose(0, 1))
            return x, cls_out
